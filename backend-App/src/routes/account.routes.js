...
import { getAccounts, getAccountDetails, createAccount, updateAccount, softDeleteAccount, deleteAccount } from '../modules/accounts/account.controller.js'
...
router.post('/viewAccount/:id',authenticateToken, getAccountDetails);
